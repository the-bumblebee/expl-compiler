...
int codeGen(struct tnode *t) {
    ...
    else if (t->left == NULL && t->type == inttype) {
        int reg = getReg();
        ...
        switch (t->nodetype) {
            ...
            case 15:
                        if (t->left->type != booltype) {
                            printf("Error: Type mismatch! Expected 'booltype'.\n");
                            exit(1);
                        }
            ...
            //continue
            case 17:   if(head != NULL) fprintf(target_file, "JMP L%d\n", head->l1);
                        break;

            //break
            case 18:    if(head != NULL) fprintf(target_file, "JMP L%d\n", head->l2);
                        break;
